...
Процедура RA_AdditionalFields_ДобавитьЭлементыНаФорму()
	...
	НовыйЭлемент = Элементы.Добавить("RA_НаименованиеПолноеМеждународное", Тип("ПолеФормы"), ГруппаBayer);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.ПутьКДанным = "Объект.RA_AdditionalFields_НаименованиеПолноеМеждународное";
	НовыйЭлемент.АвтоМаксимальнаяШирина = Ложь;
	НовыйЭлемент.МаксимальнаяШирина = 35;
