...
//	НовыйЭлемент.ПутьКДанным = "Объект.RA_AdditionalFields_КодSAP";
	...
	НовыйЭлемент = Элементы.Добавить("RA_XdistrСhainStatus", Тип("ПолеФормы"), ГруппаBayer);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.ПутьКДанным = "Объект.RA_AdditionalFields_XdistrСhainStatus";
	
	НовыйЭлемент = Элементы.Добавить("RA_XdistrСhainDate", Тип("ПолеФормы"), ГруппаBayer);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.ПутьКДанным = "Объект.RA_AdditionalFields_XdistrСhainDate";
	...
	НовыйЭлемент = Элементы.Добавить("RA_Brand", Тип("ПолеФормы"), ГруппаBayer);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.ПутьКДанным = "Объект.RA_AdditionalFields_Brand";
	...
	НовыйЭлемент = Элементы.Добавить("RA_СтатьяРасходов", Тип("ПолеФормы"), ГруппаBayer);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.ПутьКДанным = "Объект.RA_AdditionalFields_СтатьяРасходов";
